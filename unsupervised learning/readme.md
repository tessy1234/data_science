...
### 1. K-Mean:
   ...
   1. Preprocessing:  
   Using K-Means algorithm to improve classification performance. Unsupervised preprocessing using K-Means is followed by classification with Logistic Regression.
